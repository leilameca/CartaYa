...
export default function TermsPage() {
  return <LegalShell eyebrow="Términos" title="Reglas claras para usar CartaYa." description="Estas condiciones regulan el acceso a la plataforma por restaurantes, propietarios y miembros de su equipo.">
    <section><h2>1. El servicio</h2><p>CartaYa permite publicar menús digitales, generar códigos QR, recibir pedidos y organizar parte de la operación de un restaurante. Algunas funciones dependen del plan activo, del dispositivo, del navegador y de servicios de terceros.</p></section>
    ...
    <section><h2>8. Contacto y ley aplicable</h2><p>Para consultas sobre estos términos escribe a <a href="mailto:soporte@tucartaya.com">soporte@tucartaya.com</a>. Se interpretan conforme a las normas aplicables de la República Dominicana. Cualquier versión comercial definitiva deberá identificar al titular legal y sus datos de contacto.</p></section>
  </LegalShell>;
}
